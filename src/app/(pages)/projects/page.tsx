            ...
            <div className="basis-[700px]">
                <div className="flex flex-col">
                    <div className="flex flex-row justify-center">
                        <h2 className="bg-pink basis-[content] grow-0 shrink-0 mt-5 p-2.5 font-serif font-light">Projects</h2>
                    </div>
                    <p className="m-0 p-2.5">Here are some projects I&apos;ve worked on over the past few years:</p>
                </div>
